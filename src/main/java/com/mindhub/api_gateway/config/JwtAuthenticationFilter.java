            ...
            if (token != null && token.startsWith("Bearer ")) {
                ...
                try {
                    if (!jwtUtil.isTokenExpired(token)) {
                        ...
                        exchange.getRequest().mutate().header("role", claims.get("role", String.class)).build();
//                        exchange.mutate()
//                                .request(r -> r.header("email", claims.getSubject())
//                                        .header("role", claims.get("role", String.class))
//                                        .header("id", claims.get("id", String.class)))
//                                .build();
                    } else {
